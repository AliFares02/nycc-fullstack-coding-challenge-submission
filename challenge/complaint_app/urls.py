...
from .views import ComplaintViewSet, OpenCasesViewSet, ClosedCasesViewSet, TopComplaintTypeViewSet, ComplaintBySameDistrictViewSet
...
router.register(r'complaintsBySameDist', ComplaintBySameDistrictViewSet, basename='complaintBySameDist')
urlpatterns = [
]
